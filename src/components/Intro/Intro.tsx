...
export default function Intro() {
  return (
    <div className="container-fluid intro">
      ...
      <div className="row">
        <div className="col-md-12 offset-md-1 intro-text fs-5">
          <p>
            Hello! I'm a computer engineering student with a strong passion for
            programming.
          </p>
          <p>My main interests lie in robotics and software engineering.</p>
          <p>
            ...
            <li className="list-inline-item me-4">
              ...
              >
                <svg
                  ...
                  height="22"
                  fill="currentColor"
                  className="bi bi-instagram text-light text-decoration-none"
                  viewBox="0 0 16 16"
                >
            ...
            <li className="list-inline-item me-4">
              ...
              >
                <svg
                  ...
                  height="22"
                  fill="currentColor"
                  className="bi bi-github text-light text-decoration-none"
                  viewBox="0 0 16 16"
                >
            ...
            <li className="list-inline-item me-4">
              ...
              >
                <svg
                  ...
                  height="22"
                  fill="currentColor"
                  className="bi bi-linkedin text-light text-decoration-none"
                  viewBox="0 0 16 16"
                >
