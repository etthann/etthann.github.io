...
export default function Nav() {
  if (!process.env.REACT_APP_LINKEDIN_LINK) {
    console.error("REACT_APP_LINKEDIN_LINK is not set");
  }

  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light p-3 rounded-bottom">
      <Link
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <div className="d-flex justify-content-between w-100">
            <ul className="navbar-nav mr-auto">
              ...
              <li className="nav-item active me-4">
                <Link
                  className="text-dark text-decoration-none fs-5 home-link"
                  to="about"
                  onClick={() => {
        ...
        <div className="me-4 d-inline-block">
          ...
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-instagram text-dark text-decoration-none"
              viewBox="0 0 16 16"
            >
        ...
        <div className="me-4 d-inline-block">
          ...
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-github text-dark text-decoration-none"
              viewBox="0 0 16 16"
            >
        ...
        <div className="me-4 d-inline-block">
          ...
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-linkedin text-dark text-decoration-none"
              viewBox="0 0 16 16"
            >
