    ...
    return (
        <div className="AboutContainer">
            ...
            <div className="Text">
                ...
                <p>I'm most interested in exploring the intersections of hardware and software, delving into areas such as embedded systems, robotics, and artificial intelligence.</p>
