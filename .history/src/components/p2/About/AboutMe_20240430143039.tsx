    ...
    return (
        <div className="AboutContainer">
            ...
            <div className="Text">
                ...
                <p>I'm most interested in exploring the intersections of hardware and software, delving into areas such as full stack development, robotics, and machine.</p>
