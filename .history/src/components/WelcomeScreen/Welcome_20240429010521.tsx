...
const Welcome: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const cursorTimer = setInterval(() => {
            // Only toggle the cursor's visibility if no typing or backspacing action is occurring
            if (!(backspace && currentText.length > 0) && !(backspace && currentText.length === 0)) {
    ...
    return (
        <div className="WelcomeContainer">
            <div className="Welcome">
                <span className='WelcomeText'><p>Welcome</p></span>
