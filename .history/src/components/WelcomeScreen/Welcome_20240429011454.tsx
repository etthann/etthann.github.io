...
const Welcome: React.FC = () => {
    ...
    useEffect(() => {
        ...
        }, backspace ? Math.max(100, 2000 / currentText.length) : Math.max(200, 2000 / currentText.length));
    ...
    useEffect(() => {
        if (backspace && currentText === '') {
            setBackspace(false);
            setIndex((prevIndex) => (prevIndex + 1) % text.length);
        }
    }, [backspace, currentText, text.length]);
    ...
    return (
        <div className="WelcomeContainer">
            <div className="Welcome">
                ...
                <p>I love to program and learn new things!</p>
            </div>
        </div>
    );
}
