    ...
    return (
        <div className="navContainer">
            ...
            <div className='navSocials'>
                ...
                <a href='https://www.linkedin.com/in/ethan-ieong'><img src={linkedIn} alt='LinkedIn Account'/></a>
                <a href='https://www.linkedin.com/in/ethan-ieong'><img src={linkedIn} alt='Github Account'/></a>
            </div>
        </div>
    );
}
